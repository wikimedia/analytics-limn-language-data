   ...
   from (select *
        ...
        (select *
           from ( select count(*) as vewiki from vewiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from vewiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) ve
                ...
                left join
                ( select count(*) as cbk_zamwiki from cbk_zamwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from cbk_zamwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) cbk_zam on 1=1
                left join
                ...
                left join
                ( select count(*) as be_x_oldwiki from be_x_oldwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from be_x_oldwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) be_x_old on 1=1
                left join
        ...
        (select *
           from ( select count(*) as csbwiki from csbwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from csbwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) csb
                ...
                left join
                ( select count(*) as quwiki from quwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from quwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) qu on 1=1
                left join
                ...
                left join
                ( select count(*) as bat_smgwiki from bat_smgwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from bat_smgwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) bat_smg on 1=1
                left join
                ...
                left join
                ( select count(*) as fiu_vrowiki from fiu_vrowiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from fiu_vrowiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) fiu_vro on 1=1
                left join
        ...
        (select *
           from ( select count(*) as huwiki from huwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from huwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) hu
                left join
                ( select count(*) as nds_nlwiki from nds_nlwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from nds_nlwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) nds_nl on 1=1
                left join
                ...
                left join
                ( select count(*) as kwwiki from kwwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from kwwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) kw on 1=1
                left join
        ...
        (select *
           from ( select count(*) as nvwiki from nvwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from nvwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) nv
                left join
                ( select count(*) as pdcwiki from pdcwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from pdcwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) pdc on 1=1
                left join
                ( select count(*) as scowiki from scowiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from scowiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) sco on 1=1
                left join
                ( select count(*) as gdwiki from gdwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from gdwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) gd on 1=1
                left join
                ( select count(*) as srnwiki from srnwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from srnwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) srn on 1=1
                left join
                ( select count(*) as tpiwiki from tpiwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from tpiwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) tpi on 1=1
                left join
                ( select count(*) as urwiki from urwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from urwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) ur on 1=1
                left join
                ( select count(*) as cywiki from cywiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from cywiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) cy on 1=1
                left join
                ( select count(*) as vlswiki from vlswiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from vlswiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) vls on 1=1
                left join
                ( select count(*) as yiwiki from yiwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from yiwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) yi on 1=1
                left join
                ( select count(*) as zeawiki from zeawiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from zeawiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) zea on 1=1
                left join
                ( select count(*) as biwiki from biwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from biwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) bi on 1=1
                left join
                ( select count(*) as brwiki from brwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from brwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) br on 1=1
                left join
                ( select count(*) as chrwiki from chrwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from chrwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) chr on 1=1
                left join
                ( select count(*) as chywiki from chywiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from chywiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) chy on 1=1
                left join
                ( select count(*) as frpwiki from frpwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from frpwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) frp on 1=1
                left join
                ( select count(*) as htwiki from htwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from htwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) ht on 1=1
                left join
                ( select count(*) as lnwiki from lnwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from lnwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) ln on 1=1
                left join
                ( select count(*) as maiwiki from maiwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from maiwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) mai on 1=1
                left join
                ( select count(*) as nrmwiki from nrmwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from nrmwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) nrm on 1=1
                left join
                ( select count(*) as pcdwiki from pcdwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from pcdwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) pcd on 1=1
                left join
                ( select count(*) as pihwiki from pihwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from pihwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) pih on 1=1
                left join
                ( select count(*) as pmswiki from pmswiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from pmswiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) pms on 1=1
                left join
                ( select count(*) as smwiki from smwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from smwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) sm on 1=1
                left join
                ( select count(*) as tawiki from tawiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from tawiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) ta on 1=1
                left join
                ( select count(*) as wawiki from wawiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from wawiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) wa on 1=1
                left join
                ( select count(*) as acewiki from acewiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from acewiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) ace on 1=1
                left join
                ( select count(*) as bjnwiki from bjnwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from bjnwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) bjn on 1=1
                left join
                ( select count(*) as bugwiki from bugwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from bugwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) bug on 1=1
                left join
                ( select count(*) as bxrwiki from bxrwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from bxrwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) bxr on 1=1
         ) sixth30

            cross join

        (select *
           from ( select count(*) as chwiki from chwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from chwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) ch
                left join
                ( select count(*) as fjwiki from fjwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from fjwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) fj on 1=1
                left join
                ( select count(*) as hawwiki from hawwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from hawwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) haw on 1=1
                left join
                ( select count(*) as hifwiki from hifwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from hifwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) hif on 1=1
                left join
                ( select count(*) as jvwiki from jvwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from jvwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) jv on 1=1
                left join
                ( select count(*) as lbewiki from lbewiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from lbewiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) lbe on 1=1
                left join
                ( select count(*) as map_bmswiki from map_bmswiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from map_bmswiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) map_bms on 1=1
                left join
                ( select count(*) as mdfwiki from mdfwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from mdfwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) mdf on 1=1
                left join
                ( select count(*) as mgwiki from mgwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from mgwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) mg on 1=1
                left join
                ( select count(*) as mhrwiki from mhrwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from mhrwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) mhr on 1=1
                left join
                ( select count(*) as miwiki from miwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from miwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) mi on 1=1
                left join
                ( select count(*) as mrjwiki from mrjwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from mrjwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) mrj on 1=1
                left join
                ( select count(*) as myvwiki from myvwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from myvwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) myv on 1=1
                left join
                ( select count(*) as nawiki from nawiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from nawiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) na on 1=1
                left join
                ( select count(*) as ruwiki from ruwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from ruwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) ru on 1=1
                left join
                ( select count(*) as tetwiki from tetwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from tetwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) tet on 1=1
                left join
                ( select count(*) as towiki from towiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from towiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) to on 1=1
                left join
                ( select count(*) as tywiki from tywiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from tywiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) ty on 1=1
                left join
                ( select count(*) as xalwiki from xalwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from xalwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) xal on 1=1
                left join
                ( select count(*) as alswiki from alswiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from alswiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) als on 1=1
                left join
                ( select count(*) as angwiki from angwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from angwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) ang on 1=1
                left join
                ( select count(*) as barwiki from barwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from barwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) bar on 1=1
                left join
                ( select count(*) as dewiki from dewiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from dewiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) de on 1=1
                left join
                ( select count(*) as dsbwiki from dsbwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from dsbwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) dsb on 1=1
                left join
                ( select count(*) as fowiki from fowiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from fowiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) fo on 1=1
                left join
                ( select count(*) as frrwiki from frrwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from frrwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) frr on 1=1
                left join
                ( select count(*) as hsbwiki from hsbwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from hsbwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) hsb on 1=1
                left join
                ( select count(*) as ikwiki from ikwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from ikwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) ik on 1=1
                left join
                ( select count(*) as iswiki from iswiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from iswiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) is on 1=1
                left join
                ( select count(*) as klwiki from klwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from klwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) kl on 1=1
         ) seventh30

            cross join

        (select *
           from ( select count(*) as kshiki from kshwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from kshwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) ksh
                left join
                ( select count(*) as lbwiki from lbwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from lbwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) lb on 1=1
                left join
                ( select count(*) as ndswiki from ndswiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from ndswiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) nds on 1=1
                left join
                ( select count(*) as pflwiki from pflwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from pflwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) pfl on 1=1
                left join
                ( select count(*) as stqwiki from stqwiki.user_properties where up_property = 'cx' and up_value = 1 and up_user not in ( select up_user from stqwiki.user_properties where up_property = 'betafeatures-auto-enroll' and up_value = 1 ) ) stq on 1=1
         ) eigth30
